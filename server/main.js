...
const getNetworkGateIP = require('./controller/getNetworkGateIP/getNetworkGateIP');
...
//get the network defualt gateway ip

ipcMain.on('GET_GATEWAY_IP', getNetworkGateIP);
